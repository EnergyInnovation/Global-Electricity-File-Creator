# Validation report - US-UT

**Generated:** state_pipeline v1.2 (consolidated workbooks + literature-standard validation suite)

## Headlines

- Total annual demand: **34.9 TWh**
- Peak hour: **2018-01-03 11:00:00** at **6.0 GW**
- Cluster NRMSE: **0.402**
...
- Summer Peak: [180, 192, 194, 198, 202, 205, 206, 207, 208, 212, 214, 215, 219, 220, 222, 223, 226, 227, 233, 235, 236, 240, 241]
- Winter Peak: [3, 4, 5, 24, 37, 38, 39, 40, 348, 352, 354]
...
|---|---|---|---|---|
| residential-heating | 1996077.08 | 1996077.08 | 0.0 | 0.0 |
| residential-cooling | 1281417.06 | 1281417.06 | 0.0 | 0.0 |
| residential-lighting | 730527.84 | 730527.84 | 0.0 | 0.0 |
| residential-appliances | 3254094.37 | 3254094.37 | 0.0 | 0.0 |
| residential-other | 4677731.54 | 4677731.54 | 0.0 | 0.0 |
| residential-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| commercial-heating | 342614.3 | 342614.3 | 0.0 | 0.0 |
| commercial-cooling | 2028898.01 | 2028898.01 | 0.0 | 0.0 |
| commercial-lighting | 1117412.08 | 1117412.08 | 0.0 | 0.0 |
| commercial-appliances | 1935770.81 | 1935770.81 | -0.0 | -0.0 |
| commercial-other | 7747332.94 | 7747332.94 | 0.0 | 0.0 |
| commercial-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| LDVs | 61077.45 | 61077.45 | 0.0 | 0.0 |
| HDVs | 1472.78 | 1472.78 | 0.0 | 0.0 |
| aircraft | 0.0 | 0.0 | 0.0 | 0.0 |
| rail | 58995.14 | 58995.14 | 0.0 | 0.0 |
| ships | 0.0 | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 | 0.0 |
| industry | 9655218.08 | 9655218.08 | 0.0 | 0.0 |
...
|---|---|---|---|
| total_year | 0.079026 | 212.15 | 8760 |
| Winter | 0.077374 | 170.65 | 1368 |
| Spring | 0.14342 | 250.34 | 1488 |
| Summer | 0.108975 | 229.3 | 2784 |
| Fall | 0.108101 | 233.8 | 2304 |
| Summer Peak | 0.060577 | 90.65 | 552 |
| Winter Peak | 0.049042 | 96.04 | 264 |
...
|---|---|---|---|
| residential-heating | 0.132956 | 119.41 | 1996077.08 |
| residential-cooling | 0.143069 | 80.5 | 1281417.06 |
| residential-lighting | 0.065139 | 9.86 | 730527.84 |
| residential-appliances | 0.065061 | 24.48 | 3254094.37 |
| residential-other | 0.090781 | 20.7 | 4677731.54 |
| residential-envelope | 0.0 | 0.0 | 0.0 |
| commercial-heating | 0.102358 | 20.37 | 342614.3 |
| commercial-cooling | 0.104864 | 48.53 | 2028898.01 |
| commercial-lighting | 0.162058 | 16.62 | 1117412.08 |
| commercial-appliances | 0.110199 | 30.32 | 1935770.81 |
| commercial-other | 0.189744 | 79.83 | 7747332.94 |
| commercial-envelope | 0.0 | 0.0 | 0.0 |
| LDVs | 0.058896 | 0.82 | 61077.45 |
| HDVs | 0.105292 | 0.01 | 1472.78 |
| aircraft | 0.0 | 0.0 | 0.0 |
| rail | 0.058896 | 0.79 | 58995.14 |
| ships | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 |
| industry | 0.210269 | 153.22 | 9655218.08 |
...
|---|---|---|---|---|
| system_peak_hour | 5769.14 | 5879.3 | 0.9813 | representative max vs top-5 days actual peak average |
| summer_peak_slice | 5150.25 | 5198.1 | 0.9908 | Summer Peak slice reconstructed peak vs actual top-5 average |
| winter_peak_slice | 5769.14 | 5776.83 | 0.9987 | Winter Peak slice reconstructed peak vs actual top-5 average |
| category_peak_residential-cooling | 722.44 | 860.49 | 0.8396 |  |
| category_peak_commercial-cooling | 724.23 | 833.18 | 0.8692 |  |
| category_peak_residential-heating | 1057.55 | 1169.51 | 0.9043 |  |
| category_peak_commercial-heating | 225.96 | 256.34 | 0.8815 |  |
...
| top_100_actual_min_MW | 5516.08 | lowest MW threshold of top-100 actual hours |
| top_100_recon_avg_MW | 5492.16 | avg reconstructed MW at top-100 actual hour positions |
| top_100_actual_avg_MW | 5659.08 | avg actual MW at top-100 hours |
...
| metric | representative_MW | actual_MW | preservation_ratio | note |
|---|---|---|---|---|
| net_load_peak_hour | 5385.6 | 5436.45 | 0.9906 | representative net-load max vs top-5 days actual peak average |
| summer_peak_net_load | 5095.48 | 4993.15 | 1.0205 |  |
| winter_peak_net_load | 5385.6 | 5314.8 | 1.0133 |  |
...
|---|---|---|---|
| top_1pct | 124.46 | 88 | top 1% of LDC = top ~87 hours |
| top_5pct | 112.5 | 438 | top 5% of LDC = top ~438 hours |
| overall | 94.13 | 8760 | full 8760 LDC |
...
| metric | value | note |
|---|---|---|
| summer_daily_corr_buildings_vs_solar_cf | -0.5142 | correlation of daily summer building demand vs daily solar CF |
| peak_day_buildings_doy | 194 | day-of-year of peak building demand day |
| net_load_peak_shift_-14d | 5547.46 | shifted gen by -14d; peak hour 2018-01-03 20:00:00 |
| net_load_peak_shift_-7d | 5574.96 | shifted gen by -7d; peak hour 2018-01-03 20:00:00 |
| net_load_peak_shift_0d | 5555.76 | shifted gen by 0d; peak hour 2018-01-03 20:00:00 |
| net_load_peak_shift_7d | 5525.76 | shifted gen by 7d; peak hour 2018-01-03 20:00:00 |
| net_load_peak_shift_14d | 5435.06 | shifted gen by 14d; peak hour 2018-01-03 20:00:00 |
...
|---|---|---|---|---|
| UT_total_annual_TWh | 34.89 |  |  | EIA SEDS / EIA-923 cross-check; verify against primary source |
| UT_solar_pv_annual_TWh | 5.4726 | 5.4726 | 0.0 | Pipeline derived directly from Cambium hourly CFs * capacity; reference = same Cambium math (sanity self-check) |
| UT_wind_annual_TWh | 0.749 | 0.749 | 0.0 | Pipeline derived from Cambium hourly CFs * capacity for onshore + offshore wind; reference = same Cambium math |
| cambium_capacity_solar-pv_MW | 1812.7 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_solar-pv-dist_MW | 482.1 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_onshore-wind_MW | 389.7 |  |  | staff-review against Cambium Scenario Viewer |
...
|---|---|---|---|---|
| solar-pv | 0.2963 | 0.2963 | 0.6975 | 0.6975 |
| solar-pv-dist | 0.1817 | 0.1817 | 0.4681 | 0.4681 |
| onshore-wind | 0.2194 | 0.2194 | 0.2230 | 0.2230 |
...
**Diagnostic - summer daily correlation (buildings demand vs solar CF):** -0.514
...
|---|---|---|---|
| -14 | 5547 | 2018-01-03 20:00:00 | 3272 |
| -7 | 5575 | 2018-01-03 20:00:00 | 3272 |
| 0 | 5556 | 2018-01-03 20:00:00 | 3272 |
| 7 | 5526 | 2018-01-03 20:00:00 | 3272 |
| 14 | 5435 | 2018-01-03 20:00:00 | 3272 |
...
|---|---|---|---|---|---|
| efs | 9655.2 | 1543 | 1102 | 274 | 1.40 |
| flat | 9655.2 | 1102 | 1102 | 0 | 1.00 |
| cambium_residual | 9655.2 | 1719 | 1102 | 171 | 1.56 |
