# Validation report - US-VT

**Generated:** state_pipeline v1.2 (consolidated workbooks + literature-standard validation suite)

## Headlines

- Total annual demand: **5.7 TWh**
- Peak hour: **2018-02-06 10:00:00** at **1.0 GW**
- Cluster NRMSE: **0.649**
...
- Summer Peak: [159, 160, 163, 177, 184, 186, 193, 194, 198, 199, 202, 209, 212, 215, 222, 223, 226, 227, 228, 230, 233, 234, 235, 236]
- Winter Peak: [9, 339, 342, 345, 347, 354, 360]
...
|---|---|---|---|---|
| residential-heating | 391572.68 | 391572.68 | 0.0 | 0.0 |
| residential-cooling | 58776.08 | 58776.08 | 0.0 | 0.0 |
| residential-lighting | 198184.64 | 198184.64 | 0.0 | 0.0 |
| residential-appliances | 770884.53 | 770884.53 | 0.0 | 0.0 |
| residential-other | 849088.51 | 849088.51 | 0.0 | 0.0 |
| residential-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| commercial-heating | 53148.59 | 53148.59 | 0.0 | 0.0 |
| commercial-cooling | 226162.66 | 226162.66 | 0.0 | 0.0 |
| commercial-lighting | 162903.28 | 162903.28 | 0.0 | 0.0 |
| commercial-appliances | 380867.53 | 380867.53 | 0.0 | 0.0 |
| commercial-other | 1192541.03 | 1192541.03 | -0.0 | -0.0 |
| commercial-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| LDVs | 13507.77 | 13507.77 | 0.0 | 0.0 |
| HDVs | 152.89 | 152.89 | 0.0 | 0.0 |
| aircraft | 0.0 | 0.0 | 0.0 | 0.0 |
| rail | 0.0 | 0.0 | 0.0 | 0.0 |
| ships | 0.0 | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 | 0.0 |
| industry | 1401319.23 | 1401319.23 | 0.0 | 0.0 |
...
|---|---|---|---|
| total_year | 0.112177 | 54.26 | 8760 |
| Winter | 0.138955 | 62.99 | 1200 |
| Spring | 0.127669 | 62.28 | 2040 |
| Summer | 0.134917 | 56.22 | 3120 |
| Fall | 0.146687 | 50.23 | 1656 |
| Summer Peak | 0.059578 | 14.84 | 576 |
| Winter Peak | 0.088826 | 33.13 | 168 |
...
|---|---|---|---|
| residential-heating | 0.173252 | 33.51 | 391572.68 |
| residential-cooling | 0.156361 | 2.96 | 58776.08 |
| residential-lighting | 0.072754 | 2.99 | 198184.64 |
| residential-appliances | 0.085241 | 8.21 | 770884.53 |
| residential-other | 0.112774 | 5.13 | 849088.51 |
| residential-envelope | 0.0 | 0.0 | 0.0 |
| commercial-heating | 0.140793 | 4.63 | 53148.59 |
| commercial-cooling | 0.096793 | 5.16 | 226162.66 |
| commercial-lighting | 0.147635 | 2.42 | 162903.28 |
| commercial-appliances | 0.089382 | 4.37 | 380867.53 |
| commercial-other | 0.187316 | 10.2 | 1192541.03 |
| commercial-envelope | 0.0 | 0.0 | 0.0 |
| LDVs | 0.064046 | 0.23 | 13507.77 |
| HDVs | 0.091624 | 0.0 | 152.89 |
| aircraft | 0.0 | 0.0 | 0.0 |
| rail | 0.0 | 0.0 | 0.0 |
| ships | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 |
| industry | 0.253462 | 29.11 | 1401319.23 |
...
|---|---|---|---|---|
| system_peak_hour | 884.5 | 973.46 | 0.9086 | representative max vs top-5 days actual peak average |
| summer_peak_slice | 749.34 | 751.88 | 0.9966 | Summer Peak slice reconstructed peak vs actual top-5 average |
| winter_peak_slice | 884.5 | 890.95 | 0.9928 | Winter Peak slice reconstructed peak vs actual top-5 average |
| category_peak_residential-cooling | 16.71 | 23.64 | 0.7067 |  |
| category_peak_commercial-cooling | 69.48 | 95.11 | 0.7305 |  |
| category_peak_residential-heating | 120.5 | 223.88 | 0.5382 |  |
| category_peak_commercial-heating | 23.37 | 38.71 | 0.6037 |  |
...
| metric | value | note |
|---|---|---|
| top_100_hours_capture_pct | 0.07 | fraction of top-100 actual hours where recon >= 90% of actual |
| top_100_actual_min_MW | 919.59 | lowest MW threshold of top-100 actual hours |
| top_100_recon_avg_MW | 797.71 | avg reconstructed MW at top-100 actual hour positions |
| top_100_actual_avg_MW | 939.98 | avg actual MW at top-100 hours |
...
| metric | representative_MW | actual_MW | preservation_ratio | note |
|---|---|---|---|---|
| net_load_peak_hour | 873.12 | 860.87 | 1.0142 | representative net-load max vs top-5 days actual peak average |
| summer_peak_net_load | 726.04 | 679.25 | 1.0689 |  |
| winter_peak_net_load | 873.12 | 809.11 | 1.0791 |  |
...
|---|---|---|---|
| top_1pct | 93.42 | 88 | top 1% of LDC = top ~87 hours |
| top_5pct | 80.52 | 438 | top 5% of LDC = top ~438 hours |
| overall | 25.5 | 8760 | full 8760 LDC |
...
| metric | value | note |
|---|---|---|
| summer_daily_corr_buildings_vs_solar_cf | -0.0106 | correlation of daily summer building demand vs daily solar CF |
| peak_day_buildings_doy | 37 | day-of-year of peak building demand day |
| net_load_peak_shift_-14d | 908.0 | shifted gen by -14d; peak hour 2018-02-02 17:00:00 |
| net_load_peak_shift_-7d | 903.92 | shifted gen by -7d; peak hour 2018-12-19 19:00:00 |
| net_load_peak_shift_0d | 881.23 | shifted gen by 0d; peak hour 2018-12-08 18:00:00 |
| net_load_peak_shift_7d | 889.7 | shifted gen by 7d; peak hour 2018-01-19 10:00:00 |
| net_load_peak_shift_14d | 939.61 | shifted gen by 14d; peak hour 2018-12-13 18:00:00 |
...
|---|---|---|---|---|
| VT_total_annual_TWh | 5.7 |  |  | EIA SEDS / EIA-923 cross-check; verify against primary source |
| VT_solar_pv_annual_TWh | 0.4587 | 0.4587 | 0.0 | Pipeline derived directly from Cambium hourly CFs * capacity; reference = same Cambium math (sanity self-check) |
| VT_wind_annual_TWh | 1.4082 | 1.4082 | 0.0 | Pipeline derived from Cambium hourly CFs * capacity for onshore + offshore wind; reference = same Cambium math |
| cambium_capacity_solar-pv_MW | 130.3 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_solar-pv-dist_MW | 172.8 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_onshore-wind_MW | 385.8 |  |  | staff-review against Cambium Scenario Viewer |
...
|---|---|---|---|---|
| solar-pv | 0.2060 | 0.2060 | 0.5250 | 0.5250 |
| solar-pv-dist | 0.1477 | 0.1477 | 0.3556 | 0.3556 |
| onshore-wind | 0.4167 | 0.4167 | 0.2921 | 0.2921 |
...
**Diagnostic - summer daily correlation (buildings demand vs solar CF):** -0.011
...
|---|---|---|---|
| -14 | 908 | 2018-02-02 17:00:00 | 437 |
| -7 | 904 | 2018-12-19 19:00:00 | 437 |
| 0 | 881 | 2018-12-08 18:00:00 | 437 |
| 7 | 890 | 2018-01-19 10:00:00 | 437 |
| 14 | 940 | 2018-12-13 18:00:00 | 437 |
...
|---|---|---|---|---|---|
| efs | 1401.3 | 223 | 160 | 41 | 1.40 |
| flat | 1401.3 | 160 | 160 | 0 | 1.00 |
| cambium_residual | 1401.3 | 300 | 160 | 32 | 1.87 |
