# Validation report - US-MD

**Generated:** state_pipeline v1.2 (consolidated workbooks + literature-standard validation suite)

## Headlines

- Total annual demand: **61.1 TWh**
- Peak hour: **2018-01-18 09:00:00** at **13.2 GW**
- Cluster NRMSE: **0.515**
...
- Summer Peak: [152, 158, 159, 165, 171, 172, 190, 191, 192, 194, 199, 200, 202, 203, 204, 205, 207, 213, 214, 215, 220, 221, 222, 225, 226, 229, 233, 234, 239, 240, 241]
...
|---|---|---|---|---|
| residential-heating | 6244698.12 | 6244698.12 | 0.0 | 0.0 |
| residential-cooling | 3393698.71 | 3393698.71 | 0.0 | 0.0 |
| residential-lighting | 1179012.31 | 1179012.31 | 0.0 | 0.0 |
| residential-appliances | 7421570.93 | 7421570.93 | 0.0 | 0.0 |
| residential-other | 10914812.43 | 10914812.43 | -0.0 | -0.0 |
| residential-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| commercial-heating | 898179.95 | 898179.95 | -0.0 | -0.0 |
| commercial-cooling | 6408352.87 | 6408352.87 | 0.0 | 0.0 |
| commercial-lighting | 3023124.27 | 3023124.27 | 0.0 | 0.0 |
| commercial-appliances | 5487895.66 | 5487895.66 | 0.0 | 0.0 |
| commercial-other | 12418669.4 | 12418669.4 | 0.0 | 0.0 |
| commercial-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| LDVs | 123338.4 | 123338.4 | 0.0 | 0.0 |
| HDVs | 1727.38 | 1727.38 | 0.0 | 0.0 |
| aircraft | 0.0 | 0.0 | 0.0 | 0.0 |
| rail | 61956.3 | 61956.3 | -0.0 | -0.0 |
| ships | 0.0 | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 | 0.0 |
| industry | 3539954.7 | 3539954.7 | 0.0 | 0.0 |
...
|---|---|---|---|
| total_year | 0.077078 | 555.9 | 8760 |
| Winter | 0.103655 | 651.79 | 1416 |
| Spring | 0.115168 | 683.51 | 816 |
| Summer | 0.119584 | 566.51 | 3624 |
| Fall | 0.098292 | 509.7 | 1992 |
| Summer Peak | 0.064779 | 311.49 | 744 |
| Winter Peak | 0.110354 | 529.07 | 168 |
...
|---|---|---|---|
| residential-heating | 0.084314 | 321.64 | 6244698.12 |
| residential-cooling | 0.149448 | 228.13 | 3393698.71 |
| residential-lighting | 0.057709 | 13.73 | 1179012.31 |
| residential-appliances | 0.073574 | 64.81 | 7421570.93 |
| residential-other | 0.084965 | 47.08 | 10914812.43 |
| residential-envelope | 0.0 | 0.0 | 0.0 |
| commercial-heating | 0.069241 | 46.32 | 898179.95 |
| commercial-cooling | 0.103571 | 162.21 | 6408352.87 |
| commercial-lighting | 0.17314 | 49.47 | 3023124.27 |
| commercial-appliances | 0.094751 | 65.07 | 5487895.66 |
| commercial-other | 0.197632 | 127.03 | 12418669.4 |
| commercial-envelope | 0.0 | 0.0 | 0.0 |
| LDVs | 0.065526 | 2.32 | 123338.4 |
| HDVs | 0.079563 | 0.01 | 1727.38 |
| aircraft | 0.0 | 0.0 | 0.0 |
| rail | 0.065526 | 1.16 | 61956.3 |
| ships | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 |
| industry | 0.231593 | 79.82 | 3539954.7 |
...
|---|---|---|---|---|
| system_peak_hour | 12066.67 | 12698.17 | 0.9503 | representative max vs top-5 days actual peak average |
| summer_peak_slice | 9349.61 | 9412.47 | 0.9933 | Summer Peak slice reconstructed peak vs actual top-5 average |
| winter_peak_slice | 12066.67 | 12091.53 | 0.9979 | Winter Peak slice reconstructed peak vs actual top-5 average |
| category_peak_residential-cooling | 1688.77 | 2179.7 | 0.7748 |  |
| category_peak_commercial-cooling | 2209.93 | 2742.87 | 0.8057 |  |
| category_peak_residential-heating | 4435.18 | 5005.95 | 0.886 |  |
| category_peak_commercial-heating | 862.3 | 950.96 | 0.9068 |  |
...
| metric | value | note |
|---|---|---|
| top_100_hours_capture_pct | 0.53 | fraction of top-100 actual hours where recon >= 90% of actual |
| top_100_actual_min_MW | 11088.99 | lowest MW threshold of top-100 actual hours |
| top_100_recon_avg_MW | 10568.46 | avg reconstructed MW at top-100 actual hour positions |
| top_100_actual_avg_MW | 11736.76 | avg actual MW at top-100 hours |
...
| metric | representative_MW | actual_MW | preservation_ratio | note |
|---|---|---|---|---|
| net_load_peak_hour | 11484.74 | 11697.43 | 0.9818 | representative net-load max vs top-5 days actual peak average |
| summer_peak_net_load | 8478.66 | 7928.32 | 1.0694 |  |
| winter_peak_net_load | 11484.74 | 11242.9 | 1.0215 |  |
...
|---|---|---|---|
| top_1pct | 615.55 | 88 | top 1% of LDC = top ~87 hours |
| top_5pct | 549.18 | 438 | top 5% of LDC = top ~438 hours |
| overall | 233.51 | 8760 | full 8760 LDC |
...
| metric | value | note |
|---|---|---|
| summer_daily_corr_buildings_vs_solar_cf | -0.0595 | correlation of daily summer building demand vs daily solar CF |
| peak_day_buildings_doy | 18 | day-of-year of peak building demand day |
| net_load_peak_shift_-14d | 11967.21 | shifted gen by -14d; peak hour 2018-01-23 08:00:00 |
| net_load_peak_shift_-7d | 11789.5 | shifted gen by -7d; peak hour 2018-01-19 06:00:00 |
| net_load_peak_shift_0d | 12357.81 | shifted gen by 0d; peak hour 2018-01-18 08:00:00 |
| net_load_peak_shift_7d | 11927.33 | shifted gen by 7d; peak hour 2018-01-19 07:00:00 |
| net_load_peak_shift_14d | 11763.33 | shifted gen by 14d; peak hour 2018-01-19 07:00:00 |
...
|---|---|---|---|---|
| MD_total_annual_TWh | 61.12 |  |  | EIA SEDS / EIA-923 cross-check; verify against primary source |
| MD_solar_pv_annual_TWh | 17.8669 | 17.8669 | 0.0 | Pipeline derived directly from Cambium hourly CFs * capacity; reference = same Cambium math (sanity self-check) |
| MD_wind_annual_TWh | 1.4873 | 1.4873 | 0.0 | Pipeline derived from Cambium hourly CFs * capacity for onshore + offshore wind; reference = same Cambium math |
| cambium_capacity_solar-pv_MW | 7620.5 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_solar-pv-dist_MW | 1394.7 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_onshore-wind_MW | 190.0 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_offshore-wind_MW | 248.0 |  |  | staff-review against Cambium Scenario Viewer |
...
|---|---|---|---|---|
| solar-pv | 0.2380 | 0.2380 | 0.5709 | 0.5709 |
| solar-pv-dist | 0.1621 | 0.1621 | 0.3642 | 0.3642 |
| onshore-wind | 0.3678 | 0.3678 | 0.2184 | 0.2184 |
| offshore-wind | 0.4028 | 0.4028 | 0.2786 | 0.2786 |
...
**Diagnostic - summer daily correlation (buildings demand vs solar CF):** -0.059
...
|---|---|---|---|
| -14 | 11967 | 2018-01-23 08:00:00 | 4767 |
| -7 | 11790 | 2018-01-19 06:00:00 | 4767 |
| 0 | 12358 | 2018-01-18 08:00:00 | 4767 |
| 7 | 11927 | 2018-01-19 07:00:00 | 4767 |
| 14 | 11763 | 2018-01-19 07:00:00 | 4767 |
...
|---|---|---|---|---|---|
| efs | 3540.0 | 580 | 404 | 99 | 1.43 |
| flat | 3540.0 | 404 | 404 | 0 | 1.00 |
| cambium_residual | 3540.0 | 1099 | 404 | 169 | 2.72 |
