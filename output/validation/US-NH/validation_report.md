# Validation report - US-NH

**Generated:** state_pipeline v1.2 (consolidated workbooks + literature-standard validation suite)

## Headlines

- Total annual demand: **11.1 TWh**
- Peak hour: **2018-01-23 11:00:00** at **2.1 GW**
- Cluster NRMSE: **0.426**
...
- Summer Peak: [178, 198, 199, 205, 212, 215, 222, 228, 233]
- Winter Peak: [18, 22, 23, 24, 27, 32, 47]
...
|---|---|---|---|---|
| residential-heating | 840322.39 | 840322.39 | -0.0 | -0.0 |
| residential-cooling | 112834.7 | 112834.7 | 0.0 | 0.0 |
| residential-lighting | 402660.61 | 402660.61 | 0.0 | 0.0 |
| residential-appliances | 1663689.92 | 1663689.92 | 0.0 | 0.0 |
| residential-other | 1908728.02 | 1908728.02 | -0.0 | -0.0 |
| residential-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| commercial-heating | 106738.28 | 106738.28 | 0.0 | 0.0 |
| commercial-cooling | 456670.57 | 456670.57 | 0.0 | 0.0 |
| commercial-lighting | 343206.33 | 343206.33 | 0.0 | 0.0 |
| commercial-appliances | 803285.46 | 803285.46 | 0.0 | 0.0 |
| commercial-other | 2515738.57 | 2515738.57 | 0.0 | 0.0 |
| commercial-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| LDVs | 33100.51 | 33100.51 | -0.0 | -0.0 |
| HDVs | 505.76 | 505.76 | 0.0 | 0.0 |
| aircraft | 0.0 | 0.0 | 0.0 | 0.0 |
| rail | 0.0 | 0.0 | 0.0 | 0.0 |
| ships | 0.0 | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 | 0.0 |
| industry | 1953266.35 | 1953266.35 | 0.0 | 0.0 |
...
|---|---|---|---|
| total_year | 0.068007 | 74.61 | 8760 |
| Winter | 0.087696 | 75.4 | 1536 |
| Spring | 0.090133 | 70.95 | 2184 |
| Summer | 0.100106 | 78.94 | 2184 |
| Fall | 0.121295 | 78.83 | 2472 |
| Summer Peak | 0.040209 | 24.95 | 216 |
| Winter Peak | 0.076446 | 60.26 | 168 |
...
|---|---|---|---|
| residential-heating | 0.114444 | 47.42 | 840322.39 |
| residential-cooling | 0.138538 | 6.07 | 112834.7 |
| residential-lighting | 0.067029 | 5.56 | 402660.61 |
| residential-appliances | 0.076399 | 15.35 | 1663689.92 |
| residential-other | 0.097312 | 9.14 | 1908728.02 |
| residential-envelope | 0.0 | 0.0 | 0.0 |
| commercial-heating | 0.100597 | 6.04 | 106738.28 |
| commercial-cooling | 0.093393 | 10.78 | 456670.57 |
| commercial-lighting | 0.131524 | 4.9 | 343206.33 |
| commercial-appliances | 0.067887 | 7.71 | 803285.46 |
| commercial-other | 0.196951 | 26.21 | 2515738.57 |
| commercial-envelope | 0.0 | 0.0 | 0.0 |
| LDVs | 0.057898 | 0.55 | 33100.51 |
| HDVs | 0.103145 | 0.01 | 505.76 |
| aircraft | 0.0 | 0.0 | 0.0 |
| rail | 0.0 | 0.0 | 0.0 |
| ships | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 |
| industry | 0.222015 | 41.36 | 1953266.35 |
...
|---|---|---|---|---|
| system_peak_hour | 1939.54 | 2026.18 | 0.9572 | representative max vs top-5 days actual peak average |
| summer_peak_slice | 1534.91 | 1537.59 | 0.9983 | Summer Peak slice reconstructed peak vs actual top-5 average |
| winter_peak_slice | 1939.54 | 1971.02 | 0.984 | Winter Peak slice reconstructed peak vs actual top-5 average |
| category_peak_residential-cooling | 51.81 | 65.68 | 0.7888 |  |
| category_peak_commercial-cooling | 170.83 | 211.73 | 0.8068 |  |
| category_peak_residential-heating | 475.8 | 534.0 | 0.891 |  |
| category_peak_commercial-heating | 75.31 | 80.93 | 0.9305 |  |
...
| metric | value | note |
|---|---|---|
| top_100_hours_capture_pct | 0.81 | fraction of top-100 actual hours where recon >= 90% of actual |
| top_100_actual_min_MW | 1857.71 | lowest MW threshold of top-100 actual hours |
| top_100_recon_avg_MW | 1803.87 | avg reconstructed MW at top-100 actual hour positions |
| top_100_actual_avg_MW | 1920.89 | avg actual MW at top-100 hours |
...
| metric | representative_MW | actual_MW | preservation_ratio | note |
|---|---|---|---|---|
| net_load_peak_hour | 1915.34 | 1898.3 | 1.009 | representative net-load max vs top-5 days actual peak average |
| summer_peak_net_load | 1488.21 | 1443.0 | 1.0313 |  |
| winter_peak_net_load | 1915.34 | 1871.14 | 1.0236 |  |
...
|---|---|---|---|
| top_1pct | 66.47 | 88 | top 1% of LDC = top ~87 hours |
| top_5pct | 52.91 | 438 | top 5% of LDC = top ~438 hours |
| overall | 25.68 | 8760 | full 8760 LDC |
...
| metric | value | note |
|---|---|---|
| summer_daily_corr_buildings_vs_solar_cf | 0.054 | correlation of daily summer building demand vs daily solar CF |
| peak_day_buildings_doy | 22 | day-of-year of peak building demand day |
| net_load_peak_shift_-14d | 1963.1 | shifted gen by -14d; peak hour 2018-01-18 18:00:00 |
| net_load_peak_shift_-7d | 1934.55 | shifted gen by -7d; peak hour 2018-01-27 18:00:00 |
| net_load_peak_shift_0d | 1972.19 | shifted gen by 0d; peak hour 2018-01-23 11:00:00 |
| net_load_peak_shift_7d | 1869.01 | shifted gen by 7d; peak hour 2018-01-19 11:00:00 |
| net_load_peak_shift_14d | 1963.29 | shifted gen by 14d; peak hour 2018-01-23 11:00:00 |
...
|---|---|---|---|---|
| NH_total_annual_TWh | 11.14 |  |  | EIA SEDS / EIA-923 cross-check; verify against primary source |
| NH_solar_pv_annual_TWh | 0.5212 | 0.5212 | 0.0 | Pipeline derived directly from Cambium hourly CFs * capacity; reference = same Cambium math (sanity self-check) |
| NH_wind_annual_TWh | 0.836 | 0.836 | 0.0 | Pipeline derived from Cambium hourly CFs * capacity for onshore + offshore wind; reference = same Cambium math |
| cambium_capacity_solar-pv_MW | 132.4 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_solar-pv-dist_MW | 202.2 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_onshore-wind_MW | 237.2 |  |  | staff-review against Cambium Scenario Viewer |
...
|---|---|---|---|---|
| solar-pv | 0.2166 | 0.2166 | 0.5342 | 0.5342 |
| solar-pv-dist | 0.1524 | 0.1524 | 0.3232 | 0.3232 |
| onshore-wind | 0.4023 | 0.4023 | 0.2931 | 0.2931 |
...
**Diagnostic - summer daily correlation (buildings demand vs solar CF):** 0.054
...
|---|---|---|---|
| -14 | 1963 | 2018-01-18 18:00:00 | 1117 |
| -7 | 1935 | 2018-01-27 18:00:00 | 1117 |
| 0 | 1972 | 2018-01-23 11:00:00 | 1117 |
| 7 | 1869 | 2018-01-19 11:00:00 | 1117 |
| 14 | 1963 | 2018-01-23 11:00:00 | 1117 |
...
|---|---|---|---|---|---|
| efs | 1953.3 | 345 | 223 | 62 | 1.55 |
| flat | 1953.3 | 223 | 223 | 0 | 1.00 |
| cambium_residual | 1953.3 | 747 | 223 | 111 | 3.35 |
