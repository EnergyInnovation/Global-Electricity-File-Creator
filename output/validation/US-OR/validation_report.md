# Validation report - US-OR

**Generated:** state_pipeline v1.2 (consolidated workbooks + literature-standard validation suite)

## Headlines

- Total annual demand: **55.3 TWh**
- Peak hour: **2018-01-24 13:00:00** at **9.1 GW**
- Cluster NRMSE: **0.499**
...
- Summer Peak: [156, 177, 180, 187, 199, 202, 207, 208, 220, 226, 230, 243]
- Winter Peak: [4, 9, 10, 12, 13, 24, 32, 37, 40, 41, 44, 45, 47, 59, 319, 331, 333, 345, 349, 362]
...
|---|---|---|---|---|
| residential-heating | 3356307.15 | 3356307.15 | 0.0 | 0.0 |
| residential-cooling | 279760.84 | 279760.84 | 0.0 | 0.0 |
| residential-lighting | 1655187.57 | 1655187.57 | 0.0 | 0.0 |
| residential-appliances | 6585987.69 | 6585987.69 | -0.0 | -0.0 |
| residential-other | 8766157.68 | 8766157.68 | 0.0 | 0.0 |
| residential-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| commercial-heating | 826427.32 | 826427.32 | 0.0 | 0.0 |
| commercial-cooling | 2131421.45 | 2131421.45 | 0.0 | 0.0 |
| commercial-lighting | 1609273.15 | 1609273.15 | 0.0 | 0.0 |
| commercial-appliances | 3328663.54 | 3328663.54 | 0.0 | 0.0 |
| commercial-other | 9040269.64 | 9040269.64 | -0.0 | -0.0 |
| commercial-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| LDVs | 73243.49 | 73243.49 | 0.0 | 0.0 |
| HDVs | 2382.58 | 2382.58 | 0.0 | 0.0 |
| aircraft | 0.0 | 0.0 | 0.0 | 0.0 |
| rail | 53381.48 | 53381.48 | 0.0 | 0.0 |
| ships | 0.0 | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 | 0.0 |
| industry | 17571184.16 | 17571184.16 | 0.0 | 0.0 |
...
|---|---|---|---|
| total_year | 0.102183 | 436.21 | 8760 |
| Winter | 0.128904 | 496.37 | 2904 |
| Spring | 0.147514 | 487.89 | 1584 |
| Summer | 0.107702 | 402.25 | 1920 |
| Fall | 0.108982 | 430.64 | 1584 |
| Summer Peak | 0.064785 | 150.16 | 288 |
| Winter Peak | 0.069425 | 227.48 | 480 |
...
|---|---|---|---|
| residential-heating | 0.194205 | 234.13 | 3356307.15 |
| residential-cooling | 0.115637 | 18.05 | 279760.84 |
| residential-lighting | 0.072812 | 25.04 | 1655187.57 |
| residential-appliances | 0.075492 | 58.64 | 6585987.69 |
| residential-other | 0.102754 | 49.46 | 8766157.68 |
| residential-envelope | 0.0 | 0.0 | 0.0 |
| commercial-heating | 0.134091 | 53.53 | 826427.32 |
| commercial-cooling | 0.083605 | 42.95 | 2131421.45 |
| commercial-lighting | 0.156843 | 24.38 | 1609273.15 |
| commercial-appliances | 0.082945 | 36.64 | 3328663.54 |
| commercial-other | 0.202561 | 96.91 | 9040269.64 |
| commercial-envelope | 0.0 | 0.0 | 0.0 |
| LDVs | 0.061062 | 1.15 | 73243.49 |
| HDVs | 0.123391 | 0.02 | 2382.58 |
| aircraft | 0.0 | 0.0 | 0.0 |
| rail | 0.061062 | 0.84 | 53381.48 |
| ships | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 |
| industry | 0.203148 | 308.65 | 17571184.16 |
...
|---|---|---|---|---|
| system_peak_hour | 8419.8 | 9004.67 | 0.935 | representative max vs top-5 days actual peak average |
| summer_peak_slice | 7609.5 | 7640.34 | 0.996 | Summer Peak slice reconstructed peak vs actual top-5 average |
| winter_peak_slice | 8419.8 | 8530.7 | 0.987 | Winter Peak slice reconstructed peak vs actual top-5 average |
| category_peak_residential-cooling | 180.9 | 249.76 | 0.7243 |  |
| category_peak_commercial-cooling | 689.71 | 875.88 | 0.7874 |  |
| category_peak_residential-heating | 1199.74 | 1493.08 | 0.8035 |  |
| category_peak_commercial-heating | 402.51 | 503.92 | 0.7987 |  |
...
| metric | value | note |
|---|---|---|
| top_100_hours_capture_pct | 0.71 | fraction of top-100 actual hours where recon >= 90% of actual |
| top_100_actual_min_MW | 8602.67 | lowest MW threshold of top-100 actual hours |
| top_100_recon_avg_MW | 7964.2 | avg reconstructed MW at top-100 actual hour positions |
| top_100_actual_avg_MW | 8732.34 | avg actual MW at top-100 hours |
...
| metric | representative_MW | actual_MW | preservation_ratio | note |
|---|---|---|---|---|
| net_load_peak_hour | 8248.86 | 8371.51 | 0.9853 | representative net-load max vs top-5 days actual peak average |
| summer_peak_net_load | 7359.4 | 6938.09 | 1.0607 |  |
| winter_peak_net_load | 8248.86 | 7852.63 | 1.0505 |  |
...
|---|---|---|---|
| top_1pct | 390.6 | 88 | top 1% of LDC = top ~87 hours |
| top_5pct | 370.77 | 438 | top 5% of LDC = top ~438 hours |
| overall | 178.53 | 8760 | full 8760 LDC |
...
| metric | value | note |
|---|---|---|
| summer_daily_corr_buildings_vs_solar_cf | 0.0233 | correlation of daily summer building demand vs daily solar CF |
| peak_day_buildings_doy | 25 | day-of-year of peak building demand day |
| net_load_peak_shift_-14d | 8517.5 | shifted gen by -14d; peak hour 2018-12-18 21:00:00 |
| net_load_peak_shift_-7d | 8499.28 | shifted gen by -7d; peak hour 2018-12-21 12:00:00 |
| net_load_peak_shift_0d | 8606.24 | shifted gen by 0d; peak hour 2018-01-13 21:00:00 |
| net_load_peak_shift_7d | 8370.16 | shifted gen by 7d; peak hour 2018-12-22 21:00:00 |
| net_load_peak_shift_14d | 8262.71 | shifted gen by 14d; peak hour 2018-12-29 21:00:00 |
...
|---|---|---|---|---|
| OR_total_annual_TWh | 55.28 |  |  | EIA SEDS / EIA-923 cross-check; verify against primary source |
| OR_solar_pv_annual_TWh | 2.8662 | 2.8662 | 0.0 | Pipeline derived directly from Cambium hourly CFs * capacity; reference = same Cambium math (sanity self-check) |
| OR_wind_annual_TWh | 10.3546 | 10.3546 | 0.0 | Pipeline derived from Cambium hourly CFs * capacity for onshore + offshore wind; reference = same Cambium math |
| cambium_capacity_solar-pv_MW | 1137.4 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_solar-pv-dist_MW | 286.8 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_onshore-wind_MW | 3951.8 |  |  | staff-review against Cambium Scenario Viewer |
...
|---|---|---|---|---|
| solar-pv | 0.2521 | 0.2521 | 0.6999 | 0.6999 |
| solar-pv-dist | 0.1412 | 0.1412 | 0.4509 | 0.4509 |
| onshore-wind | 0.2991 | 0.2991 | 0.3059 | 0.3059 |
...
**Diagnostic - summer daily correlation (buildings demand vs solar CF):** 0.023
...
|---|---|---|---|
| -14 | 8518 | 2018-12-18 21:00:00 | 4801 |
| -7 | 8499 | 2018-12-21 12:00:00 | 4801 |
| 0 | 8606 | 2018-01-13 21:00:00 | 4801 |
| 7 | 8370 | 2018-12-22 21:00:00 | 4801 |
| 14 | 8263 | 2018-12-29 21:00:00 | 4801 |
...
|---|---|---|---|---|---|
| efs | 17571.2 | 2931 | 2006 | 457 | 1.46 |
| flat | 17571.2 | 2006 | 2006 | 0 | 1.00 |
| cambium_residual | 17571.2 | 3786 | 2006 | 539 | 1.89 |
