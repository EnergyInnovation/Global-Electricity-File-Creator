# Validation report - US-NV

**Generated:** state_pipeline v1.2 (consolidated workbooks + literature-standard validation suite)

## Headlines

- Total annual demand: **40.4 TWh**
- Peak hour: **2018-07-04 19:00:00** at **7.3 GW**
- Cluster NRMSE: **0.342**
...
- Summer Peak: [180, 184, 185, 186, 193, 194, 198, 199, 205, 206, 207, 208, 213, 216, 219, 221, 222, 223, 230, 233, 234, 243]
- Winter Peak: [24, 27, 45, 47, 349, 353, 354]
...
|---|---|---|---|---|
| residential-heating | 1676731.54 | 1676731.54 | -0.0 | -0.0 |
| residential-cooling | 2910878.66 | 2910878.66 | 0.0 | 0.0 |
| residential-lighting | 924735.93 | 924735.93 | 0.0 | 0.0 |
| residential-appliances | 3941945.19 | 3941945.19 | 0.0 | 0.0 |
| residential-other | 5676166.47 | 5676166.47 | 0.0 | 0.0 |
| residential-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| commercial-heating | 200932.3 | 200932.3 | 0.0 | 0.0 |
| commercial-cooling | 2561652.99 | 2561652.99 | -0.0 | -0.0 |
| commercial-lighting | 1024065.06 | 1024065.06 | 0.0 | 0.0 |
| commercial-appliances | 1774446.07 | 1774446.07 | 0.0 | 0.0 |
| commercial-other | 7101641.27 | 7101641.27 | 0.0 | 0.0 |
| commercial-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| LDVs | 59335.82 | 59335.82 | 0.0 | 0.0 |
| HDVs | 1186.45 | 1186.45 | 0.0 | 0.0 |
| aircraft | 0.0 | 0.0 | 0.0 | 0.0 |
| rail | 0.0 | 0.0 | 0.0 | 0.0 |
| ships | 0.0 | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 | 0.0 |
| industry | 12514317.62 | 12514317.62 | 0.0 | 0.0 |
...
|---|---|---|---|
| total_year | 0.082598 | 294.62 | 8760 |
| Winter | 0.145966 | 386.89 | 2520 |
| Spring | 0.120123 | 321.48 | 1176 |
| Summer | 0.10942 | 293.98 | 2568 |
| Fall | 0.068263 | 204.78 | 1800 |
| Summer Peak | 0.055659 | 147.05 | 528 |
| Winter Peak | 0.078995 | 158.58 | 168 |
...
|---|---|---|---|
| residential-heating | 0.122892 | 117.22 | 1676731.54 |
| residential-cooling | 0.12333 | 174.09 | 2910878.66 |
| residential-lighting | 0.058166 | 10.82 | 924735.93 |
| residential-appliances | 0.082533 | 37.86 | 3941945.19 |
| residential-other | 0.104142 | 30.59 | 5676166.47 |
| residential-envelope | 0.0 | 0.0 | 0.0 |
| commercial-heating | 0.08277 | 14.11 | 200932.3 |
| commercial-cooling | 0.097331 | 57.2 | 2561652.99 |
| commercial-lighting | 0.172209 | 14.49 | 1024065.06 |
| commercial-appliances | 0.086234 | 20.46 | 1774446.07 |
| commercial-other | 0.179837 | 65.71 | 7101641.27 |
| commercial-envelope | 0.0 | 0.0 | 0.0 |
| LDVs | 0.06022 | 0.88 | 59335.82 |
| HDVs | 0.212687 | 0.03 | 1186.45 |
| aircraft | 0.0 | 0.0 | 0.0 |
| rail | 0.0 | 0.0 | 0.0 |
| ships | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 |
| industry | 0.228832 | 238.18 | 12514317.62 |
...
|---|---|---|---|---|
| system_peak_hour | 6619.74 | 7006.12 | 0.9449 | representative max vs top-5 days actual peak average |
| summer_peak_slice | 6619.74 | 6659.57 | 0.994 | Summer Peak slice reconstructed peak vs actual top-5 average |
| winter_peak_slice | 5826.49 | 5856.97 | 0.9948 | Winter Peak slice reconstructed peak vs actual top-5 average |
| category_peak_residential-cooling | 1720.27 | 2038.06 | 0.8441 |  |
| category_peak_commercial-cooling | 886.08 | 988.24 | 0.8966 |  |
| category_peak_residential-heating | 1056.71 | 1300.78 | 0.8124 |  |
| category_peak_commercial-heating | 210.82 | 266.73 | 0.7904 |  |
...
| top_100_actual_min_MW | 6529.51 | lowest MW threshold of top-100 actual hours |
| top_100_recon_avg_MW | 6302.61 | avg reconstructed MW at top-100 actual hour positions |
| top_100_actual_avg_MW | 6723.97 | avg actual MW at top-100 hours |
...
| metric | representative_MW | actual_MW | preservation_ratio | note |
|---|---|---|---|---|
| net_load_peak_hour | 6611.64 | 6963.99 | 0.9494 | representative net-load max vs top-5 days actual peak average |
| summer_peak_net_load | 6611.64 | 6597.18 | 1.0022 |  |
| winter_peak_net_load | 5612.39 | 5590.49 | 1.0039 |  |
...
|---|---|---|---|
| top_1pct | 227.97 | 88 | top 1% of LDC = top ~87 hours |
| top_5pct | 219.11 | 438 | top 5% of LDC = top ~438 hours |
| overall | 124.49 | 8760 | full 8760 LDC |
...
| metric | value | note |
|---|---|---|
| summer_daily_corr_buildings_vs_solar_cf | -0.1794 | correlation of daily summer building demand vs daily solar CF |
| peak_day_buildings_doy | 185 | day-of-year of peak building demand day |
| net_load_peak_shift_-14d | 7247.65 | shifted gen by -14d; peak hour 2018-07-04 19:00:00 |
| net_load_peak_shift_-7d | 7271.65 | shifted gen by -7d; peak hour 2018-07-04 19:00:00 |
| net_load_peak_shift_0d | 7264.15 | shifted gen by 0d; peak hour 2018-07-04 19:00:00 |
| net_load_peak_shift_7d | 7209.25 | shifted gen by 7d; peak hour 2018-07-04 19:00:00 |
| net_load_peak_shift_14d | 7204.05 | shifted gen by 14d; peak hour 2018-07-04 19:00:00 |
...
|---|---|---|---|---|
| NV_total_annual_TWh | 40.37 |  |  | EIA SEDS / EIA-923 cross-check; verify against primary source |
| NV_solar_pv_annual_TWh | 11.0464 | 11.0464 | 0.0 | Pipeline derived directly from Cambium hourly CFs * capacity; reference = same Cambium math (sanity self-check) |
| NV_wind_annual_TWh | 0.3398 | 0.3398 | 0.0 | Pipeline derived from Cambium hourly CFs * capacity for onshore + offshore wind; reference = same Cambium math |
| cambium_capacity_solar-pv_MW | 3781.2 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_solar-pv-dist_MW | 548.4 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_onshore-wind_MW | 150.0 |  |  | staff-review against Cambium Scenario Viewer |
...
|---|---|---|---|---|
| solar-pv | 0.3033 | 0.3033 | 0.6546 | 0.6546 |
| solar-pv-dist | 0.2084 | 0.2084 | 0.4247 | 0.4247 |
| onshore-wind | 0.2586 | 0.2586 | 0.2530 | 0.2530 |
...
**Diagnostic - summer daily correlation (buildings demand vs solar CF):** -0.179
...
|---|---|---|---|
| -14 | 7248 | 2018-07-04 19:00:00 | 3308 |
| -7 | 7272 | 2018-07-04 19:00:00 | 3308 |
| 0 | 7264 | 2018-07-04 19:00:00 | 3308 |
| 7 | 7209 | 2018-07-04 19:00:00 | 3308 |
| 14 | 7204 | 2018-07-04 19:00:00 | 3308 |
...
|---|---|---|---|---|---|
| efs | 12514.3 | 1979 | 1429 | 374 | 1.39 |
| flat | 12514.3 | 1429 | 1429 | 0 | 1.00 |
| cambium_residual | 12514.3 | 2894 | 1429 | 365 | 2.03 |
