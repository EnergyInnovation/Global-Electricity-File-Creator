# Validation report - US-CO

**Generated:** state_pipeline v1.2 (consolidated workbooks + literature-standard validation suite)

## Headlines

- Total annual demand: **57.8 TWh**
- Peak hour: **2018-12-19 20:00:00** at **9.7 GW**
- Cluster NRMSE: **0.692**
...
- Summer Peak: [191, 192, 193, 200, 201, 209, 213, 221, 222, 237]
- Winter Peak: [2, 5, 7, 10, 32, 36, 39, 45, 47, 305, 306, 312, 319, 325, 333, 339, 342, 354, 356, 361]
...
|---|---|---|---|---|
| residential-heating | 3604018.17 | 3604018.17 | -0.0 | -0.0 |
| residential-cooling | 864047.19 | 864047.19 | 0.0 | 0.0 |
| residential-lighting | 1397509.38 | 1397509.38 | 0.0 | 0.0 |
| residential-appliances | 6236008.21 | 6236008.21 | 0.0 | 0.0 |
| residential-other | 8925011.72 | 8925011.72 | -0.0 | -0.0 |
| residential-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| commercial-heating | 622121.92 | 622121.92 | 0.0 | 0.0 |
| commercial-cooling | 2717904.45 | 2717904.45 | 0.0 | 0.0 |
| commercial-lighting | 1902968.93 | 1902968.93 | 0.0 | 0.0 |
| commercial-appliances | 3175410.32 | 3175410.32 | 0.0 | 0.0 |
| commercial-other | 12737573.27 | 12737573.27 | 0.0 | 0.0 |
| commercial-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| LDVs | 108960.8 | 108960.8 | 0.0 | 0.0 |
| HDVs | 2097.21 | 2097.21 | 0.0 | 0.0 |
| aircraft | 0.0 | 0.0 | 0.0 | 0.0 |
| rail | 93609.9 | 93609.9 | 0.0 | 0.0 |
| ships | 0.0 | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 | 0.0 |
| industry | 15429524.38 | 15429524.38 | 0.0 | 0.0 |
...
|---|---|---|---|
| total_year | 0.10469 | 461.12 | 8760 |
| Winter | 0.155106 | 568.44 | 2136 |
| Spring | 0.105698 | 440.01 | 3192 |
| Summer | 0.115239 | 350.57 | 1104 |
| Fall | 0.105637 | 483.81 | 1608 |
| Summer Peak | 0.081818 | 180.95 | 240 |
| Winter Peak | 0.125608 | 442.17 | 480 |
...
|---|---|---|---|
| residential-heating | 0.165369 | 306.07 | 3604018.17 |
| residential-cooling | 0.157013 | 52.1 | 864047.19 |
| residential-lighting | 0.071823 | 21.68 | 1397509.38 |
| residential-appliances | 0.073836 | 54.72 | 6236008.21 |
| residential-other | 0.114487 | 54.91 | 8925011.72 |
| residential-envelope | 0.0 | 0.0 | 0.0 |
| commercial-heating | 0.116979 | 52.71 | 622121.92 |
| commercial-cooling | 0.116687 | 61.07 | 2717904.45 |
| commercial-lighting | 0.172103 | 30.06 | 1902968.93 |
| commercial-appliances | 0.096658 | 43.04 | 3175410.32 |
| commercial-other | 0.200554 | 124.08 | 12737573.27 |
| commercial-envelope | 0.0 | 0.0 | 0.0 |
| LDVs | 0.065177 | 1.94 | 108960.8 |
| HDVs | 0.12481 | 0.02 | 2097.21 |
| aircraft | 0.0 | 0.0 | 0.0 |
| rail | 0.065177 | 1.66 | 93609.9 |
| ships | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 |
| industry | 0.231624 | 338.9 | 15429524.38 |
...
|---|---|---|---|---|
| system_peak_hour | 8434.18 | 9550.78 | 0.8831 | representative max vs top-5 days actual peak average |
| summer_peak_slice | 7899.02 | 7980.8 | 0.9898 | Summer Peak slice reconstructed peak vs actual top-5 average |
| winter_peak_slice | 8434.18 | 8522.92 | 0.9896 | Winter Peak slice reconstructed peak vs actual top-5 average |
| category_peak_residential-cooling | 385.32 | 474.56 | 0.8119 |  |
| category_peak_commercial-cooling | 773.45 | 945.42 | 0.8181 |  |
| category_peak_residential-heating | 1408.06 | 2114.74 | 0.6658 |  |
| category_peak_commercial-heating | 342.48 | 523.16 | 0.6546 |  |
...
| top_100_actual_min_MW | 8785.31 | lowest MW threshold of top-100 actual hours |
| top_100_recon_avg_MW | 7943.1 | avg reconstructed MW at top-100 actual hour positions |
| top_100_actual_avg_MW | 9111.13 | avg actual MW at top-100 hours |
...
| metric | representative_MW | actual_MW | preservation_ratio | note |
|---|---|---|---|---|
| net_load_peak_hour | 8313.28 | 8194.83 | 1.0145 | representative net-load max vs top-5 days actual peak average |
| summer_peak_net_load | 7412.52 | 6825.9 | 1.0859 |  |
| winter_peak_net_load | 8313.28 | 7692.53 | 1.0807 |  |
...
|---|---|---|---|
| top_1pct | 836.43 | 88 | top 1% of LDC = top ~87 hours |
| top_5pct | 547.74 | 438 | top 5% of LDC = top ~438 hours |
| overall | 228.94 | 8760 | full 8760 LDC |
...
| metric | value | note |
|---|---|---|
| summer_daily_corr_buildings_vs_solar_cf | -0.0494 | correlation of daily summer building demand vs daily solar CF |
| peak_day_buildings_doy | 354 | day-of-year of peak building demand day |
| net_load_peak_shift_-14d | 8954.76 | shifted gen by -14d; peak hour 2018-12-19 20:00:00 |
| net_load_peak_shift_-7d | 9074.57 | shifted gen by -7d; peak hour 2018-12-20 19:00:00 |
| net_load_peak_shift_0d | 8285.77 | shifted gen by 0d; peak hour 2018-02-08 20:00:00 |
| net_load_peak_shift_7d | 8479.14 | shifted gen by 7d; peak hour 2018-01-03 20:00:00 |
| net_load_peak_shift_14d | 8870.67 | shifted gen by 14d; peak hour 2018-12-19 21:00:00 |
...
|---|---|---|---|---|
| CO_total_annual_TWh | 57.82 |  |  | EIA SEDS / EIA-923 cross-check; verify against primary source |
| CO_solar_pv_annual_TWh | 5.5624 | 5.5624 | 0.0 | Pipeline derived directly from Cambium hourly CFs * capacity; reference = same Cambium math (sanity self-check) |
| CO_wind_annual_TWh | 15.9271 | 15.9271 | 0.0 | Pipeline derived from Cambium hourly CFs * capacity for onshore + offshore wind; reference = same Cambium math |
| cambium_capacity_solar-pv_MW | 1619.1 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_solar-pv-dist_MW | 858.1 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_onshore-wind_MW | 5139.0 |  |  | staff-review against Cambium Scenario Viewer |
...
|---|---|---|---|---|
| solar-pv | 0.2926 | 0.2926 | 0.6444 | 0.6444 |
| solar-pv-dist | 0.1879 | 0.1879 | 0.3703 | 0.3703 |
| onshore-wind | 0.3538 | 0.3538 | 0.2906 | 0.2906 |
...
**Diagnostic - summer daily correlation (buildings demand vs solar CF):** -0.049
...
|---|---|---|---|
| -14 | 8955 | 2018-12-19 20:00:00 | 4147 |
| -7 | 9075 | 2018-12-20 19:00:00 | 4147 |
| 0 | 8286 | 2018-02-08 20:00:00 | 4147 |
| 7 | 8479 | 2018-01-03 20:00:00 | 4147 |
| 14 | 8871 | 2018-12-19 21:00:00 | 4147 |
...
|---|---|---|---|---|---|
| efs | 15429.5 | 2578 | 1761 | 455 | 1.46 |
| flat | 15429.5 | 1761 | 1761 | 0 | 1.00 |
| cambium_residual | 15429.5 | 3232 | 1761 | 499 | 1.83 |
