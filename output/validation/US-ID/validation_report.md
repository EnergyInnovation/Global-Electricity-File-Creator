...
- Total annual demand: **26.8 TWh**
- Peak hour: **2018-06-28 18:00:00** at **4.2 GW**
- Cluster NRMSE: **0.503**
...
- Summer Peak: [164, 165, 167, 173, 179, 180, 187, 188, 191, 192, 193, 194, 198, 199, 201, 202, 205, 206, 207, 208, 209, 212, 213, 219, 220, 221, 226, 227, 240]
- Winter Peak: [2, 4, 9, 10, 12, 16, 19, 37, 58]
...
|---|---|---|---|---|
| residential-heating | 1749252.64 | 1749252.64 | 0.0 | 0.0 |
| residential-cooling | 522516.12 | 522516.12 | -0.0 | -0.0 |
| residential-lighting | 692979.19 | 692979.19 | 0.0 | 0.0 |
| residential-appliances | 2988563.89 | 2988563.89 | 0.0 | 0.0 |
| residential-other | 4278481.83 | 4278481.83 | 0.0 | 0.0 |
| residential-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| commercial-heating | 205504.4 | 205504.4 | 0.0 | 0.0 |
| commercial-cooling | 931228.02 | 931228.02 | 0.0 | 0.0 |
| commercial-lighting | 602057.44 | 602057.44 | 0.0 | 0.0 |
| commercial-appliances | 1043484.76 | 1043484.76 | 0.0 | 0.0 |
| commercial-other | 4176201.64 | 4176201.64 | 0.0 | 0.0 |
| commercial-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| LDVs | 39136.24 | 39136.24 | 0.0 | 0.0 |
| HDVs | 1520.64 | 1520.64 | 0.0 | 0.0 |
| aircraft | 0.0 | 0.0 | 0.0 | 0.0 |
| rail | 0.0 | 0.0 | 0.0 | 0.0 |
| ships | 0.0 | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 | 0.0 |
| industry | 9594256.24 | 9594256.24 | 0.0 | 0.0 |
...
|---|---|---|---|
| total_year | 0.09165 | 168.95 | 8760 |
| Winter | 0.146672 | 239.38 | 1152 |
| Spring | 0.086505 | 128.72 | 1800 |
| Summer | 0.141242 | 207.96 | 1848 |
| Fall | 0.108945 | 169.35 | 3048 |
| Summer Peak | 0.05794 | 78.05 | 696 |
| Winter Peak | 0.061443 | 81.94 | 216 |
...
|---|---|---|---|
| residential-heating | 0.223935 | 148.81 | 1749252.64 |
| residential-cooling | 0.117673 | 29.28 | 522516.12 |
| residential-lighting | 0.074454 | 11.43 | 692979.19 |
| residential-appliances | 0.078239 | 28.17 | 2988563.89 |
| residential-other | 0.110603 | 24.51 | 4278481.83 |
| residential-envelope | 0.0 | 0.0 | 0.0 |
| commercial-heating | 0.167137 | 16.89 | 205504.4 |
| commercial-cooling | 0.084137 | 19.65 | 931228.02 |
| commercial-lighting | 0.152726 | 9.46 | 602057.44 |
| commercial-appliances | 0.104824 | 16.06 | 1043484.76 |
| commercial-other | 0.198813 | 45.38 | 4176201.64 |
| commercial-envelope | 0.0 | 0.0 | 0.0 |
| LDVs | 0.055797 | 0.59 | 39136.24 |
| HDVs | 0.055133 | 0.01 | 1520.64 |
| aircraft | 0.0 | 0.0 | 0.0 |
| rail | 0.0 | 0.0 | 0.0 |
| ships | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 |
| industry | 0.16993 | 189.49 | 9594256.24 |
...
|---|---|---|---|---|
| system_peak_hour | 4035.97 | 4194.28 | 0.9623 | representative max vs top-5 days actual peak average |
| summer_peak_slice | 4035.97 | 4036.24 | 0.9999 | Summer Peak slice reconstructed peak vs actual top-5 average |
| winter_peak_slice | 3972.32 | 3999.09 | 0.9933 | Winter Peak slice reconstructed peak vs actual top-5 average |
| category_peak_residential-cooling | 323.33 | 408.7 | 0.7911 |  |
| category_peak_commercial-cooling | 330.01 | 400.69 | 0.8236 |  |
| category_peak_residential-heating | 683.49 | 775.06 | 0.8818 |  |
| category_peak_commercial-heating | 105.89 | 123.12 | 0.86 |  |
...
| top_100_actual_min_MW | 4006.84 | lowest MW threshold of top-100 actual hours |
| top_100_recon_avg_MW | 3883.13 | avg reconstructed MW at top-100 actual hour positions |
| top_100_actual_avg_MW | 4067.67 | avg actual MW at top-100 hours |
...
| metric | representative_MW | actual_MW | preservation_ratio | note |
|---|---|---|---|---|
| net_load_peak_hour | 3954.69 | 4017.99 | 0.9842 | representative net-load max vs top-5 days actual peak average |
| summer_peak_net_load | 3943.98 | 3868.48 | 1.0195 |  |
| winter_peak_net_load | 3954.69 | 3779.14 | 1.0465 |  |
...
|---|---|---|---|
| top_1pct | 84.85 | 88 | top 1% of LDC = top ~87 hours |
| top_5pct | 87.71 | 438 | top 5% of LDC = top ~438 hours |
| overall | 61.82 | 8760 | full 8760 LDC |
...
| metric | value | note |
|---|---|---|
| summer_daily_corr_buildings_vs_solar_cf | -0.0915 | correlation of daily summer building demand vs daily solar CF |
| peak_day_buildings_doy | 2 | day-of-year of peak building demand day |
| net_load_peak_shift_-14d | 4075.88 | shifted gen by -14d; peak hour 2018-07-13 19:00:00 |
| net_load_peak_shift_-7d | 4093.64 | shifted gen by -7d; peak hour 2018-06-29 19:00:00 |
| net_load_peak_shift_0d | 4086.94 | shifted gen by 0d; peak hour 2018-06-29 19:00:00 |
| net_load_peak_shift_7d | 4058.24 | shifted gen by 7d; peak hour 2018-06-29 19:00:00 |
| net_load_peak_shift_14d | 4036.46 | shifted gen by 14d; peak hour 2018-06-28 19:00:00 |
...
|---|---|---|---|---|
| ID_total_annual_TWh | 26.83 |  |  | EIA SEDS / EIA-923 cross-check; verify against primary source |
| ID_solar_pv_annual_TWh | 0.8293 | 0.8293 | 0.0 | Pipeline derived directly from Cambium hourly CFs * capacity; reference = same Cambium math (sanity self-check) |
| ID_wind_annual_TWh | 2.3621 | 2.3621 | 0.0 | Pipeline derived from Cambium hourly CFs * capacity for onshore + offshore wind; reference = same Cambium math |
| cambium_capacity_solar-pv_MW | 240.0 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_solar-pv-dist_MW | 210.9 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_onshore-wind_MW | 915.8 |  |  | staff-review against Cambium Scenario Viewer |
...
|---|---|---|---|---|
| solar-pv | 0.2414 | 0.2414 | 0.7015 | 0.7015 |
| solar-pv-dist | 0.1742 | 0.1742 | 0.5155 | 0.5155 |
| onshore-wind | 0.2944 | 0.2944 | 0.2059 | 0.2059 |
...
**Diagnostic - summer daily correlation (buildings demand vs solar CF):** -0.091
...
|---|---|---|---|
| -14 | 4076 | 2018-07-13 19:00:00 | 2698 |
| -7 | 4094 | 2018-06-29 19:00:00 | 2698 |
| 0 | 4087 | 2018-06-29 19:00:00 | 2698 |
| 7 | 4058 | 2018-06-29 19:00:00 | 2698 |
| 14 | 4036 | 2018-06-28 19:00:00 | 2698 |
...
|---|---|---|---|---|---|
| efs | 9594.3 | 1810 | 1095 | 306 | 1.65 |
| flat | 9594.3 | 1095 | 1095 | 0 | 1.00 |
| cambium_residual | 9594.3 | 2104 | 1095 | 330 | 1.92 |
