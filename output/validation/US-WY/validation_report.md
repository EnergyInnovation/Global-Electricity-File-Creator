# Validation report - US-WY

**Generated:** state_pipeline v1.2 (consolidated workbooks + literature-standard validation suite)

## Headlines

- Total annual demand: **16.6 TWh**
- Peak hour: **2018-01-10 13:00:00** at **2.4 GW**
- Cluster NRMSE: **0.628**
...
- Summer Peak: [164, 191, 192, 193, 209, 222, 226, 233, 235, 241]
- Winter Peak: [25, 37, 39, 321, 332, 361]
...
|---|---|---|---|---|
| residential-heating | 542444.02 | 542444.02 | 0.0 | 0.0 |
| residential-cooling | 94162.95 | 94162.95 | 0.0 | 0.0 |
| residential-lighting | 207717.76 | 207717.76 | 0.0 | 0.0 |
| residential-appliances | 894217.47 | 894217.47 | -0.0 | -0.0 |
| residential-other | 1289264.36 | 1289264.36 | 0.0 | 0.0 |
| residential-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| commercial-heating | 137819.75 | 137819.75 | -0.0 | -0.0 |
| commercial-cooling | 456245.6 | 456245.6 | 0.0 | 0.0 |
| commercial-lighting | 317711.02 | 317711.02 | 0.0 | 0.0 |
| commercial-appliances | 550770.81 | 550770.81 | 0.0 | 0.0 |
| commercial-other | 2204287.81 | 2204287.81 | 0.0 | 0.0 |
| commercial-envelope | 0.0 | 0.0 | 0.0 | 0.0 |
| LDVs | 14864.4 | 14864.4 | -0.0 | -0.0 |
| HDVs | 688.26 | 688.26 | 0.0 | 0.0 |
| aircraft | 0.0 | 0.0 | 0.0 | 0.0 |
| rail | 0.0 | 0.0 | 0.0 | 0.0 |
| ships | 0.0 | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 | 0.0 |
| industry | 9861056.45 | 9861056.45 | 0.0 | 0.0 |
...
|---|---|---|---|
| total_year | 0.184533 | 184.6 | 8760 |
| Winter | 0.221978 | 227.43 | 2880 |
| Spring | 0.174969 | 82.46 | 48 |
| Summer | 0.188793 | 190.02 | 3480 |
| Fall | 0.16332 | 139.24 | 1968 |
| Summer Peak | 0.085439 | 42.92 | 240 |
| Winter Peak | 0.135369 | 86.77 | 144 |
...
|---|---|---|---|
| residential-heating | 0.206378 | 40.62 | 542444.02 |
| residential-cooling | 0.144652 | 4.75 | 94162.95 |
| residential-lighting | 0.073021 | 3.28 | 207717.76 |
| residential-appliances | 0.081768 | 9.41 | 894217.47 |
| residential-other | 0.110943 | 7.89 | 1289264.36 |
| residential-envelope | 0.0 | 0.0 | 0.0 |
| commercial-heating | 0.174448 | 10.18 | 137819.75 |
| commercial-cooling | 0.108743 | 8.76 | 456245.6 |
| commercial-lighting | 0.155546 | 4.82 | 317711.02 |
| commercial-appliances | 0.113321 | 8.31 | 550770.81 |
| commercial-other | 0.183374 | 20.25 | 2204287.81 |
| commercial-envelope | 0.0 | 0.0 | 0.0 |
| LDVs | 0.077332 | 0.32 | 14864.4 |
| HDVs | 0.348911 | 0.05 | 688.26 |
| aircraft | 0.0 | 0.0 | 0.0 |
| rail | 0.0 | 0.0 | 0.0 |
| ships | 0.0 | 0.0 | 0.0 |
| motorbikes | 0.0 | 0.0 | 0.0 |
| industry | 0.198486 | 165.18 | 9861056.45 |
...
|---|---|---|---|---|
| system_peak_hour | 2304.58 | 2438.26 | 0.9452 | representative max vs top-5 days actual peak average |
| summer_peak_slice | 2304.58 | 2316.33 | 0.9949 | Summer Peak slice reconstructed peak vs actual top-5 average |
| winter_peak_slice | 2254.33 | 2272.15 | 0.9922 | Winter Peak slice reconstructed peak vs actual top-5 average |
| category_peak_residential-cooling | 36.34 | 44.51 | 0.8166 |  |
| category_peak_commercial-cooling | 144.0 | 160.08 | 0.8996 |  |
| category_peak_residential-heating | 185.93 | 229.28 | 0.8109 |  |
| category_peak_commercial-heating | 53.64 | 69.81 | 0.7683 |  |
...
| metric | value | note |
|---|---|---|
| top_100_hours_capture_pct | 0.06 | fraction of top-100 actual hours where recon >= 90% of actual |
| top_100_actual_min_MW | 2360.0 | lowest MW threshold of top-100 actual hours |
| top_100_recon_avg_MW | 2015.25 | avg reconstructed MW at top-100 actual hour positions |
| top_100_actual_avg_MW | 2391.01 | avg actual MW at top-100 hours |
...
| metric | representative_MW | actual_MW | preservation_ratio | note |
|---|---|---|---|---|
| net_load_peak_hour | 2220.02 | 2248.39 | 0.9874 | representative net-load max vs top-5 days actual peak average |
| summer_peak_net_load | 2220.02 | 2115.74 | 1.0493 |  |
| winter_peak_net_load | 2145.46 | 2046.29 | 1.0485 |  |
...
|---|---|---|---|
| top_1pct | 118.49 | 88 | top 1% of LDC = top ~87 hours |
| top_5pct | 193.0 | 438 | top 5% of LDC = top ~438 hours |
| overall | 129.55 | 8760 | full 8760 LDC |
...
| metric | value | note |
|---|---|---|
| summer_daily_corr_buildings_vs_solar_cf | -0.3358 | correlation of daily summer building demand vs daily solar CF |
| peak_day_buildings_doy | 6 | day-of-year of peak building demand day |
| net_load_peak_shift_-14d | 2350.03 | shifted gen by -14d; peak hour 2018-02-02 21:00:00 |
| net_load_peak_shift_-7d | 2303.5 | shifted gen by -7d; peak hour 2018-02-01 12:00:00 |
| net_load_peak_shift_0d | 2278.46 | shifted gen by 0d; peak hour 2018-08-21 14:00:00 |
| net_load_peak_shift_7d | 2299.98 | shifted gen by 7d; peak hour 2018-01-03 11:00:00 |
| net_load_peak_shift_14d | 2318.48 | shifted gen by 14d; peak hour 2018-01-03 20:00:00 |
...
|---|---|---|---|---|
| WY_total_annual_TWh | 16.57 |  |  | EIA SEDS / EIA-923 cross-check; verify against primary source |
| WY_solar_pv_annual_TWh | 0.2243 | 0.2243 | 0.0 | Pipeline derived directly from Cambium hourly CFs * capacity; reference = same Cambium math (sanity self-check) |
| WY_wind_annual_TWh | 9.7214 | 9.7214 | 0.0 | Pipeline derived from Cambium hourly CFs * capacity for onshore + offshore wind; reference = same Cambium math |
| cambium_capacity_solar-pv_MW | 92.0 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_solar-pv-dist_MW | 11.5 |  |  | staff-review against Cambium Scenario Viewer |
| cambium_capacity_onshore-wind_MW | 2782.1 |  |  | staff-review against Cambium Scenario Viewer |
...
|---|---|---|---|---|
| solar-pv | 0.2555 | 0.2555 | 0.6258 | 0.6258 |
| solar-pv-dist | 0.1827 | 0.1827 | 0.4309 | 0.4309 |
| onshore-wind | 0.3989 | 0.3989 | 0.2783 | 0.2783 |
...
**Diagnostic - summer daily correlation (buildings demand vs solar CF):** -0.336
...
|---|---|---|---|
| -14 | 2350 | 2018-02-02 21:00:00 | 756 |
| -7 | 2304 | 2018-02-01 12:00:00 | 756 |
| 0 | 2278 | 2018-08-21 14:00:00 | 756 |
| 7 | 2300 | 2018-01-03 11:00:00 | 756 |
| 14 | 2318 | 2018-01-03 20:00:00 | 756 |
...
|---|---|---|---|---|---|
| efs | 9861.1 | 1589 | 1126 | 220 | 1.41 |
| flat | 9861.1 | 1126 | 1126 | 0 | 1.00 |
| cambium_residual | 9861.1 | 1506 | 1126 | 127 | 1.34 |
